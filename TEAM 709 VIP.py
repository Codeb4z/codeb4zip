...
def menu():
	...
	_IPYTHONI_(f'\x1b[1;98m◈───💀[01]💀 𝐂𝐑𝐀𝐂𝐊 𝐊𝐑𝐃𝐍 𝐁𝐀 𝐅𝐈𝐋𝐄')
...
class D:
	...
	def plerr(self):
		...
		try:
			...
			fileX = input ('\x1b[1;93m𝙁𝙄𝙇𝘼𝙆𝘼 𝘿𝘼𝙉𝙀 ➪ : ')
...
#SERVER-SETTING			
def Settings():
	print(f'\x1b[1;91m\x1b[1;96m\x1b[1;97m\x1b[1;91m[\x1b[1;97m1\x1b[1;91m]\x1b[1;97mTAZA FB \x1b[1;91m[𝐅𝐀𝐒𝐓𝐄𝐑]\n\x1b[1;91m\x1b[1;96m\x1b[1;97m\x1b[1;91m[\x1b[1;97m2\x1b[1;91m]\x1b[1;97mTAZA+KON\x1b[1;93m [𝐁𝐄𝐒𝐓]')
	...
	if hc in ['1','01']:
		...
		method.append('mobile')
	pwplus=input('\x1b[1;97m{ M } 𝐍𝐀𝐖𝐄 𝐅𝐁 𝐀𝐊𝐀𝐓 𝐁𝐀 𝐏𝐀𝐒𝐒𝐖𝐎𝐑𝐃\x1b[1;96m [𝙃𝘼𝙍𝘿]\n\x1b[1;91m\x1b[1;96m\x1b[1;97m[ A ] 𝐏𝐀𝐒𝐒𝐖𝐎𝐑𝐃   𝐘 𝐓𝐎𝐎𝐋\x1b[1;92m [𝙀𝘼𝙎𝙔]\n\x1b[1;96mSELECT : \x1b[1;97m')
	if pwplus in ['y','Y']:
		pwpluss.append('ya')
...
def passwrd():
	...
	print(' \x1b[1;91m\x1b[1;96m\x1b[1;97m𝐃𝐖 𝐁𝐀𝐑𝐀 𝐁𝐎𝐍𝐀𝐖𝐀 𝐁𝐎 𝐂𝐑𝐀𝐂𝐊\x1b[1;97m[Y]\n \x1b[1;91m\x1b[1;96m\x1b[1;97m \x1b[1;91mEXIT [T]')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r [𝙲𝙱𝟺𝚉] {P}{b}{loop}{P}•{b}{len(id)}{P}  • OK:{P}{H}{ok}{P} •  CP:{P}{M}{cp}{P} • ({bo}{'{:.0%}'.format(loop/float(len(id)))}  "),
	sys.stdout.flush()
